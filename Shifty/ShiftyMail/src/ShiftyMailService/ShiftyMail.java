...
public class ShiftyMail { //This is the class where the logic to send an email is written

    static String shiftyEmailAccount = "mailloggershifty@gmail.com"; //requires valid gmail id
    static String shiftyEmailPassword = "Shifty123456"; // correct password for gmail id
    ...
    private static Message prepareMessage(Session session, String shiftyEmailAccount, String recepient) {
        try{
            ...
            Logger.getLogger(ShiftyMail.class.getName()).log(Level.SEVERE, null, ex);
        }
        return null;  
    }
